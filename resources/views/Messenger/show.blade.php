	...
	<header class="flex items-center mb-4 py-4">
		<div class="flex justify-between mt-2 items-end w-full">
			<p class="text-muted font-light">
                ...
                <a href="/ads" class="text-muted no-underline hover:underline"> Messages </a> / {{ $convo->topic }} || {{ $convo->vendor->name }}
            </p>
		</div>
	</header>
	...
	<main>
		<div class="lg:flex -mx-3">
			<div class ="lg:w-full px-3 mb-6">
				<div class="mb-8">
					<h2 class="text-lg text-grey font-normal mb-3">{{ $convo->topic }} || {{ $convo->vendor->name }}</h2>
