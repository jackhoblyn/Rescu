...
<div class = "flex items center" style="padding-left: 8rem; padding-right: 8rem;">
	<form method="POST" class="mx-auto bg-white shadow-lger rounded px-8 pt-6 pb-8 mb-4 ml-9" action="/ads">
		@csrf
		<div class="mb-4">
		...
		<div class="mb-4-6">
			<input type="text" class="mb-6 shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" name="phone" placeholder="phone type">
		</div>

		<label class="block text-blue text-sm font-bold mb-2 mt-3" for="price" style="font-size: 1.2rem">Price</label>
		<div class="mb-4-6">
			<input type="number" class="mb-6 shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" name="price" placeholder="price">
		</div>
