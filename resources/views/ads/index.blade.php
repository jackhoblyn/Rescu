			...
			<div class="lg:w-1/3 px-3 mb-5">
				<div class="card" style="height: 100%; position: relative; ">
					<div>
						...
						<h1 style= "color: green; text-align: right; font-size: 2rem; padding-top: 2%"> ${{ $ad->price }} </h1></br>

						<div class="text-grey">{{ str_limit($ad->description, 60) }}</div>

						<img class = "center pt-6 mt-6" sizes="70vw" src="/uploads/photos/{{ $ad->photo }}" alt="Card image" style="position: relative; object-fit: cover; object-position: center; min-height: 250px; max-width: 250px;">
