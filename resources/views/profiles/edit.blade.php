		 ...
		 <div class="row justify-content-center">
            ...
            <div class="flex mt-2 w-full">
                <div style="margin-left: 20%; margin-bottom: 3rem;">
                    ...
                    <form enctype="multipart/form-data" action="{{ Auth::user()->photo() }}" method="POST">
			...
			<div class="mb-4">
				...
				<div class="mb-4-6">
					<input type="text" class="mb-6 shadow appearance-none border border-blue-light rounded w-full py-2 px-3 text-grey-darker" name="name" placeholder="title" value="{{Auth::user()->name}}" style="font-size: 1.2rem">
				</div>

				<label class="block text-blue text-sm font-bold mb-2 block" for="title" style="font-size: 1.2rem">City/Town</label>
				<div class="mb-4-6">
					<input type="text" class="mb-6 shadow appearance-none border border-blue-light rounded w-full py-2 px-3 text-grey-darker" name="city" placeholder="New York" value="{{Auth::user()->city}}" style="font-size: 1.2rem">
				</div>
			
				<label class="block text-blue text-sm font-bold mb-2 mt-4" for="description" style="font-size: 1.2rem">Bio</label>
				<div class="mb-4-6">
					<textarea name="bio" class="textarea bg-transparent border border-blue-light rounded p-2 text-m w-full" style="min-height: 200px;" placeholder="I am a full time student from Dublin who can't seem to keep their phone in one piece" >{{Auth::user()->bio}}</textarea>
				</div>
