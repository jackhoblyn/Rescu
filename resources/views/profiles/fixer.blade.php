                                        ...
                                        <div style="text-align: center;">
                                            <div style="box-sizing: border-box;">
                                                <div style="display: inline-block;">
                                                    <a href="/vendor/profile/{{Auth('vendor')->user()->id }}/edit">
                                                        <div class = "textWithBlurredBg" style="position: relative; width: 200px; height: 200px; display: block">
                                                            <img src="/uploads/avatars/{{ Auth('vendor')->user()->avatar }}" style=" border-radius:50%;">
                ...
                <div style="width: 66.66%; float: left; margin-bottom: 5rem;">
                    <div style="margin-left: 110px;">
                        <div style="box-sizing: border-box; margin-bottom: 15px;">
                            <h3 class="mt-2" style="font-weight:430; font-size: 2.2rem; margin-top: .6rem">{{ Auth('vendor')->user()->name }} </h3>
                        </div>
                        <div>
                            <p style="font-size: 1.3rem; color: grey"> Joined in {{ Auth('vendor')->user()->created_at->year }}</p>
                        </div>
                        ...
                        <div style="margin-top: 32px;">
                            ...
                            <div style="margin-top: 1rem; margin-bottom: 1rem;">
                                <h2 style="font-size: 2rem;">{{ Auth('vendor')->user()->reviews->count() }} Reviews</h2>
                            ...
                            @forelse (Auth('vendor')->user()->reviews as $review)
                            <div style="margin-top: 1.3rem;">
                                
                                <p style="font-size: 1.1rem; margin-bottom: 0.6rem;"><b>{{$review->user->name}}</b></p>
