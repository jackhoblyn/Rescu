					...
					<div>
						...
						<div class = "w-full mt-8 pt-6">
							<div class="flex w-full pt-6 mt-6" style="align-items: center; justify-content: center;">
								...
								@if($repair->progress == 100 && $repair->payment =='yes')
								    
							    	<form action="{{ $repair->list(). '/finish' }}" method="POST">
										@csrf
										
										<button type="submit" class="bg-red ml-6 hover:bg-red-dark text-white font-bold py-2 px-4 rounded" style="min-width: 8rem; font-size: 0.9rem; ">Device Returned to customer</button>
