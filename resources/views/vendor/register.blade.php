    ...
    <div class = "container mx-auto">
         <form class="mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 ml-9" method="POST" action="{{ route('register.vendor') }}" aria-label="{{ __('Register') }}">
            ...
            <div class="mb-4">
                ...
                <label for="name" class="block text-grey-darker text-sm font-bold mb-2">{{ __('Business Name') }}</label>
                <div class="mb-4-6">
            ...
            <div class="mb-6">
                <label for=”type” class="block text-grey-darker text-sm font-bold mb-2" >Vendor Type:</label>
                <select class="form-control" name="type" id="type">
                    <option value="shop">Actual Shop</option>
            ...
            <br><br>
            <a class="btn btn-link" href="/login/vendor">
